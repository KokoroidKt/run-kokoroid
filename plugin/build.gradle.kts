...
signing {
    val signingKey: String? = providers.environmentVariable("GPG_PRIVATE_KEY").orNull
    val signingPassword: String? = providers.environmentVariable("GPG_PASSPHRASE").orNull
